...
show_info() {
    ...
    case "$topic" in
        ...
        *)
            ...
            info_desc " - Choose VPN ports: both random by default; Vision + REALITY on TCP 443; or manual."
            info_desc "   Vision + REALITY -> TCP 443; XHTTP + REALITY -> generated high TCP port."
